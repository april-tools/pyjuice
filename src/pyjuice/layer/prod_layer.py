...
class ProdLayer(Layer,nn.Module):
    ...
    @torch.compile(mode = "reduce-overhead", disable=int(os.environ.get('JUICE_COMPILE_FLAG', str(0xFFFF))) & 1 << 11 == 0)
    ...
    @torch.compile(mode = "reduce-overhead", disable=int(os.environ.get('JUICE_COMPILE_FLAG', str(0xFFFF))) & 1 << 10 == 0)
    ...
    @torch.compile(mode = "reduce-overhead", disable=int(os.environ.get('JUICE_COMPILE_FLAG', str(0xFFFF))) & 1 << 9 == 0)
    ...
    @torch.compile(mode = "reduce-overhead", disable=int(os.environ.get('JUICE_COMPILE_FLAG', str(0xFFFF))) & 1 << 8 == 0)
